...
/**
 * Contiene las funciones no miembro (estáticas) que operan sobre el inventario
 * de vehículos de la concesionaria, representado como una matriz de 3x3 de
 * objetos Vehiculo.
 *
 * @author grupo 1
 */
public class Consesionarios {
    ...
    public static float totalStockEnDinero(Vehiculo arr[][], String marca) {
        ...
        for (Vehiculo[] arrVehiculo : arr) {
            for (Vehiculo carro : arrVehiculo) {
    ...
    /**
     * Busca todos los vehículos cuyo año está dentro de un rango dado
     * (inclusive), recorriendo la matriz completa del inventario, y los
     * devuelve en un arreglo nuevo.
     *
     * Se recorre la matriz dos veces: la primera solo para contar cuántos
     * vehículos califican (y así saber el tamaño exacto que necesita el arreglo
     * de resultado), y la segunda para llenarlo.
     *
     * @param arr matriz 3x3 con el inventario de vehículos
     * @param anio1 año inicial del rango (inclusive)
     * @param anio2 año final del rango (inclusive)
     * @return un arreglo con los vehículos cuyo año está entre anio1 y anio2
     */
    ...
    /**
     * Busca un vehículo por su placa, recorriendo la matriz completa del
     * inventario.
     *
     * @param arr matriz 3x3 con el inventario de vehículos
     * @param placa placa que se desea buscar
     * @return la representación en texto del vehículo encontrado, o un mensaje
     * indicando que no se encontró ninguno
     */
    ...
    /**
     * Imprime por consola la representación de cada vehículo de un arreglo
     * (pensado para mostrar, por ejemplo, el resultado de RangoAnios).
     *
    ...
    public static void main(String[] args) {
        ...
        while (!opcion.equals("FIN")) {
            System.out.println(
                    "" "Que desea hacer? (escriba el literal correspondiente)

            Para salir digite:
            FIN
            1. Consultar el total en stock en dinero de una marca
            2. Buscar vehiculos por rango de anios
            3. Buscar un vehiculo por placa Cual sera su opcion ?  : """);
            opcion = sc.nextLine();
...
// utilizando estructura de datos dinamicas, va a definir la clase medico con sus funciones miembro, su diagrama UML correspondiente, las siguientes funciones no miembro
// 1.Funcion no miembro que busque en una estructura de datos dinamica, la especilidad del medico y devuelva solo los que cumple con la especialidad
// 2. devuelva el tipo de especialidad y cuantos medicos hay en ese tipo 
// 3. devuelva un miembro por su codigo de cedula.
// se tiene que generar la documentacion de la aplicacion autonoma
